...
import { StackGroup } from './axisSelectors';
...
export declare const combineStackedData: (stackGroups: Record<StackId, StackGroup> | undefined, barSettings: MaybeStackedGraphicalItem | undefined) => Series<Record<number, number>, DataKey<any>> | undefined;
